    ...
    <div className="flex h-screen">
      ...
      <div className="h-screen w-64 bg-[#3C3C3C] text-white fixed top-0 left-0 z-10">
        <ul className="p-4 space-y-4">
          <li className="mt-8">
            <Link to="/edit-photo" className="hover:text-gray-300">Edit Foto</Link>
          </li>
          <li>
            <Link to="/edit-about" className="hover:text-gray-300">Edit About</Link>
          </li>
          <li>
            <button onClick={handleLogout} className="w-full text-left hover:text-gray-300">Keluar</button>
          </li>
        </ul>
      </div>
